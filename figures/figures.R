...
cairo(file='~/Documents/temp/evolution.pdf',height=6,width=6)
pars(mfrow=c(2,2),mar=c(2.5,2.5,1.5,0.5))
evolution(examples$ThU,isochron=TRUE)
legend('topright',legend='a)',bty='n',adj=c(1.5,0),cex=1.2)
evolution(examples$ThU,isochron=FALSE,Th0i=1)
legend('topright',legend='b)',bty='n',adj=c(1.5,0),cex=1.2)
