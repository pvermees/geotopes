...
\item Apply the correction factor calculated in step \ref{corr} to the
  measured ratios for sample 91500. This gives us two estimated atomic
  $^{206}$Pb/$^{238}$U and $^{207}$Pb/$^{235}$U ratios.
