...
second term decreases from $A(^{230}Th)_\circ$ to 0, with a half-life
of $t_{1/2} = 75,380$ yr. Dividing by $A(^{232}Th)$ yields a linear
relationship between $A(^{230}Th)/A(^{232}Th)$ and $A(^{238}U) /
A(^{232}Th)$:
