...
\usepackage{amsmath,graphicx,wasysym,color,upquote}
\usepackage{longtable,textgreek,caption,enumitem,url}
...
\input{detrital-R.tex}

\part{Extending \texttt{IsoplotR}}
