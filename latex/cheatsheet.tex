...
Secular equilibrium, where $A(\cdot)$ is `the activity of $\cdot$':
\begin{equation}
A(D_1) = D_1 \lambda_1 = P \lambda_P = A(P)
\label{eq:ND1L1}
\end{equation}
...
\begin{equation}
\frac{d^{14}\mbox{C}}{dt} = -\lambda_{14} \times {}^{14}\mbox{C}
\label{eq:d14Cdt}
\end{equation}

\begin{equation}
t = -\frac{1}{\lambda_{14}}
\ln\left[\frac{d{}^{14}\mbox{C}/dt}{(d{}^{14}\mbox{C}/dt)_\circ}\right]
\label{eq:t14C}
\end{equation}
...
Ingrowth equation:
\begin{equation}
{}^{87}\mbox{Sr} = {}^{87}\mbox{Sr}_\circ + {}^{87}\mbox{Rb} \, (e^{\lambda_{87} t} - 1)
\label{eq:87Sr*}
\end{equation}

where $^{87}\mbox{Sr}_\circ$ is the initial $^{87}$Sr content.
$^{87}$Rb/$^{86}$Sr-ratio is calculated as:
\begin{equation}
\frac{^{87}\mbox{Rb}}{^{86}\mbox{Sr}} =
\frac{\mbox{Rb}}{\mbox{Sr}} \frac{\mbox{Ab}(^{87}\mbox{Rb})
  \mbox{M(Sr)}}{\mbox{Ab}(^{86}\mbox{Sr}) \mbox{M(Rb)}}
\label{eq:87Rb86Sr}
\end{equation}

where $\mbox{Ab}(\cdot)$ signifies `the abundance of $\cdot$'.
...
Rb--Sr method:
\begin{equation}
\frac{^{87}\mbox{Sr}}{^{86}\mbox{Sr}} =
\left(\frac{^{87}\mbox{Sr}}{^{86}\mbox{Sr}}\right)_\circ +
\frac{^{87}\mbox{Rb}}{^{86}\mbox{Sr}} (e^{\lambda_{87} t} - 1)
\label{eq:87Sr86Sr}
\end{equation}
...
The age equation:
\begin{equation}
^{143}\mbox{Nd} = ^{143}\mbox{Nd}_\circ + {}^{147}\mbox{Sm} (e^{\lambda_{147} t} - 1)
\label{eq:144Nd*}
\end{equation}

Isochron equation:
\begin{equation}
\frac{^{143}\mbox{Nd}}{^{144}\mbox{Nd}} =
\left(\frac{^{143}\mbox{Nd}}{^{144}\mbox{Nd}}\right)_{\circ} +
\frac{^{147}\mbox{Sm}}{^{144}\mbox{Nd}} \left(e^{\lambda_{147}t} -
1\right)
\label{eq:143Nd147Nd}
\end{equation}
...
\begin{equation}
\begin{array}{r@{~}l}
^{238}\mbox{U} \rightarrow & {}^{206}\mbox{Pb} + 8\,\alpha + 6\,\beta + 47\,\mbox{MeV} \\ 
^{235}\mbox{U} \rightarrow & {}^{207}\mbox{Pb} + 7\,\alpha + 4\,\beta + 45\,\mbox{MeV} \\
^{232}\mbox{Th} \rightarrow & {}^{208}\mbox{Pb} + 6\,\alpha + 4\,\beta + 40\,\mbox{MeV} 
\end{array}
\label{eq:UThdecay}
\end{equation}
...
\begin{equation}
  \begin{array}{rl}
    &{}^{206}\mbox{Pb}^* = {}^{238}\mbox{U} \left(e^{\lambda_{238}t} - 1\right)\\ 
    &{}^{207}\mbox{Pb}^* = {}^{235}\mbox{U} \left(e^{\lambda_{235}t} - 1\right)\\ 
    &{}^{208}\mbox{Pb}^* = {}^{232}\mbox{Th} \left(e^{\lambda_{232}t} - 1\right)
  \end{array}
  \label{eq:Pb*}
\end{equation}
...
\begin{equation}
  \begin{array}{rl}
    ...
    \ln \left(\frac{{}^{206}\mbox{Pb}^*}{{}^{238}\mbox{U}}+1\right)\\
    t_{207} & = \frac{1}{\lambda_{235}}
    \ln \left(\frac{{}^{207}\mbox{Pb}^*}{{}^{235}\mbox{U}}+1\right)\\
    t_{208} & = \frac{1}{\lambda_{232}}
    \ln \left(\frac{{}^{208}\mbox{Pb}^*}{{}^{232}\mbox{Th}}+1\right)
  \end{array}
  \label{eq:tPb*}
\end{equation}
...
\begin{equation}
\begin{array}{c}
  t_{206}=\frac{1}{\lambda_{238}}\ln\left(\frac{\left(\frac{{}^{206}\mbox{Pb}}{^{204}\mbox{Pb}}\right)-
    \left(\frac{^{206}\mbox{Pb}}{^{204}\mbox{Pb}}\right)_\circ}{\frac{^{238}\mbox{U}}{^{204}\mbox{Pb}}}+1\right)\\
  t_{207}=\frac{1}{\lambda_{235}}\ln\left(\frac{\left(\frac{^{207}\mbox{Pb}}{^{204}\mbox{Pb}}\right)-
    \left(\frac{^{207}\mbox{Pb}}{^{204}\mbox{Pb}}\right)_\circ}{\frac{^{235}\mbox{U}}{^{204}\mbox{Pb}}}+1\right)\\
  t_{208}=\frac{1}{\lambda_{232}}\ln\left(\frac{\left(\frac{^{208}\mbox{Pb}}{^{204}\mbox{Pb}}\right)-
    \left(\frac{^{208}\mbox{Pb}}{^{204}\mbox{Pb}}\right)_\circ}{\frac{^{232}\mbox{Th}}{^{204}\mbox{Pb}}}+1\right)
\end{array}
\label{eq:tPb}
\end{equation}
...
Age equation:
\begin{equation}
\frac{^{207}\mbox{Pb}^*}{^{206}\mbox{Pb}^*} = 
\frac{\left(\frac{^{207}\mbox{Pb}}{^{204}\mbox{Pb}}\right)-\left(\frac{^{207}\mbox{Pb}}{^{204}\mbox{Pb}}\right)_\circ}
{\left(\frac{^{206}\mbox{Pb}}{^{204}\mbox{Pb}}\right)-\left(\frac{^{206}\mbox{Pb}}{^{204}\mbox{Pb}}\right)_\circ}
= \frac{{}^{235}\mbox{U}}{{}^{238}\mbox{U}} \frac{e^{\lambda_{235}t}-1}{e^{\lambda_{238}t}-1}
\label{eq:PbPb}
\end{equation}

where $^{235}$U/$^{238}$U=1/137.818. For modern samples:
\begin{equation}
  \left(\frac{^{207}\mbox{Pb}}{^{206}\mbox{Pb}}\right)^*_{t=0} =
  \frac{\lambda_{235}}{\lambda_{238}}\frac{^{235}\mbox{U}}{^{238}\mbox{U}} = 0.04607
\label{eq:commonPb}
\end{equation}
...
\begin{equation}
\begin{array}{r@{~}l}
^{40}\mbox{Ar} & = {}^{40}\mbox{Ar}_\circ + {}^{40}\mbox{Ar}^*\\ 
\mbox{where~} {}^{40}\mbox{Ar}^* & =
  \frac{\lambda_e}{\lambda} {}^{40}\mbox{K} \left( e^{\lambda t} - 1 \right)
\end{array}
\label{eq:Ar}
\end{equation}
...
t = \frac{1}{\lambda} \ln\left[ 1 + \frac{\lambda}{\lambda_e}
  \left(\frac{^{40}\mbox{Ar}^*}{^{40}\mbox{K}}\right) \right]
\label{eq:K-Ar}
\end{equation}

Isochron equation:
\begin{equation}
\frac{^{40}\mbox{Ar}}{^{36}\mbox{Ar}} = \left(\frac{^{40}\mbox{Ar}}{^{36}\mbox{Ar}}\right)_\circ +
\frac{\lambda_e}{\lambda} \frac{^{40}\mbox{K}}{^{36}\mbox{Ar}} \left( e^{\lambda t} - 1 \right)
...
1 + J \left(\frac{^{40}\mbox{Ar}^*}{^{39}\mbox{Ar}}\right)_x 
\right]
\label{eq:Ar-Ar}
\end{equation}
...
1 + J \left(\frac{^{40}\mbox{Ar}^*}{^{39}\mbox{Ar}}\right)_s 
\right]
\label{eq:J}
\end{equation}
...
Isochron equation:
\begin{equation}
\frac{{}^{40}\mbox{Ar}}{{}^{36}\mbox{Ar}} =
\left(\frac{{}^{40}\mbox{Ar}}{{}^{36}\mbox{Ar}}\right)_\circ +
\frac{{}^{39}\mbox{Ar}}{{}^{36}\mbox{Ar}}\frac{e^{\lambda t} - 1}{J}
...
\begin{split}
  ...
  8 (e^{\lambda_{238}t} - 1) \mbox{[\textsuperscript{238}\mbox{U}]} + 
  7 (e^{\lambda_{235}t} - 1) \mbox{[\textsuperscript{235}\mbox{U}]} + \\
  ~ & 6 (e^{\lambda_{232}t} - 1) \mbox{[\textsuperscript{232}\mbox{Th}]} +
  (e^{\lambda_{147}t} - 1) \mbox{[\textsuperscript{147}\mbox{Sm}]}
\end{split}
\label{eq:U-Th-He}
\end{equation}
...
Age equation:
\begin{equation}
\frac{A(^{234}\mbox{U})}{A(^{238}\mbox{U})} = 1 + [ \gamma_\circ - 1 ] e^{-\lambda_{234}t} 
\label{eq:A234A238}
\end{equation}

\noindent where $\gamma_\circ =
\left[\frac{{}^{234}\mbox{U}}{{}^{238}\mbox{U}}\right]_{\mbox{init}}$ ($\approx 1.15$
for modern ocean water).
...
Ingrowth equation:
\begin{equation}
A(^{230}\mbox{Th}) = A(^{230}\mbox{Th})_\circ e^{-\lambda_{230}t} + A(^{238}\mbox{U})(1-e^{-\lambda_{230}t})
\label{eq:A230}
\end{equation}

Isochron equation:
\begin{equation}
  \frac{A(^{230}\mbox{Th})}{A(^{232}\mbox{Th})} =
  \frac{A(^{230}\mbox{Th})_\circ}{A(^{232}\mbox{Th})} e^{-\lambda_{230}t} + 
  \frac{A(^{238}\mbox{U})}{A(^{232}\mbox{Th})}(1-e^{-\lambda_{230}t})
\label{eq:230232}
\end{equation}
...
Decay series:
\begin{align}
~ & A(^{230}\mbox{Th}) =  A(^{230}\mbox{Th})^s + A(^{230}\mbox{Th})^x \label{eq:230total}\\
\mbox{with:~} & A(^{230}\mbox{Th})^s = A(^{238}\mbox{U}) (1-e^{-\lambda_{230}t}) \label{eq:230s}\\
\mbox{and:~} & A(^{230}\mbox{Th})^x = \frac{\lambda_{230}}{\lambda_{230}-\lambda_{234}} 
A(^{234}\mbox{U})_\circ^x\left(e^{-\lambda_{234}t}-e^{-\lambda_{230}t}\right) \label{eq:230x}
\end{align}

Age equation:
\begin{equation}
  \frac{A(^{230}\mbox{Th})}{A(^{238}\mbox{U})} = 1 - e^{-\lambda_{230}t} +
