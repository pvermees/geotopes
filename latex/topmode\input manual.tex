...
_D_e_s_c_r_i_p_t_i_o_n:
     ...
     curve through them using the ‘york’ function, and computes the
     corresponding isochron age, including decay constant
     uncertainties.
...
_A_r_g_u_m_e_n_t_s:
   ...
   alpha: confidence cutoff for the error ellipses and confidence
          intervals
