...
\captionof{figure}{Radial plots and MDA estimates for sample 297 of
  ...
  The MDA estimates agree to within 0.6\% despite the great
  differences in sample size and analytical precision between the two
  datasets. The ad hoc MDA estimation algorithms listed at the start
  of this Section do not fare so well, resulting in differences of 2
  -- 17\% between the LA-ICPMS and CA-TIMS data
  \citep{vermeesch2021b}.}
  \label{fig:297}
\end{center}
