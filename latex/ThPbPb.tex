...
\includegraphics[width=.9\linewidth]{../figures/PbPb.pdf}\\ \captionof{figure}{a)
  ...
  places the least abundant isotope (\textsuperscript{204}Pb) in the
  denominator, which caused strong error correlations for reasons that
  are explained in Section~\ref{sec:errorcorrelations}. These
  correlations are greatly reduced when the more abundant
  \textsuperscript{206}Pb is used as a common denominator.}
\end{center}
