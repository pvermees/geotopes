...
\item\label{it:UPbIsochron46} formats 4--6: Total-U/Pb regression
  ...
  \textsuperscript{204}Pb/\tebxtsuperscript{207}Pb
...
\item\label{it:UPbIsochron78} formats 7 and 8: Total-U-Th/Pb
  ...
  \textsuperscript{208}Pb/\tebxtsuperscript{207}Pb
  vs. \textsuperscript{235}U/\textsuperscript{207}Pb space
  (Section~\ref{sec:U-Pb-disequilibrium}).
...
\captionof{figure}{Wetherill concordia diagram of a depth-drilling
  experiment for a cycle-by-cycle LA-ICP-MS depth drilling experiment
...
\captionof{figure}{Tera-Wasserburg concordia diagram a) assuming
  ...
  would be wrong by 100\%.\\}
\label{fig:diseq}
\endgroup

If the measured activity ratios are used to infer the initial
conditions, then the concordia line terminates where those inferred
activity ratios reach unrealistic values (e.g.,
\textsuperscript{234}U/\textsuperscript{238}U=500 and
\textsuperscript{230}Th/\textsuperscript{238}U=0):

\noindent\begin{minipage}[t][][b]{.5\linewidth}
\includegraphics[width=\textwidth]{../figures/McLean.pdf}\\
\end{minipage}
\begin{minipage}[t][][t]{.5\linewidth}
  \captionof{figure}{Discordia regression of carbonate sample WHC1 of
    \citet{mclean2016b}, using measured activity ratios of
    \textsuperscript{234}U/\textsuperscript{238}U=1.1634,
    \textsuperscript{230}Th/\textsuperscript{238}U=1.0734, and initial
    activity ratios of \textsuperscript{226}Ra/\textsuperscript{238}U
    = \textsuperscript{231}Pa/\textsuperscript{235}U = 0. The measured
    \textsuperscript{234}U/\textsuperscript{238}U and
    \textsuperscript{230}Th/\textsuperscript{238}U activity ratios are
    incompatible with U--Pb ages of more than 240~ka, i.e. at 240~ka
    the initial \textsuperscript{230}Th/\textsuperscript{238}U
    activity ratio would have been 0.\\}
  \label{fig:McLean}
\end{minipage}
...
\begingroup \captionof{figure}{2D isochrons of U--Pb data with a true
  age of 5Ma and the following initial activity ratios:
  \textsuperscript{234}U/\textsuperscript{238}U = 10,
  \textsuperscript{230}Th/\textsuperscript{238}U = 0,
  \textsuperscript{226}Ra/\textsuperscript{238}U = 0, and
  \textsuperscript{231}Pa/\textsuperscript{235}U = 0. Due to this
  expired initial disequilibrium, the
  \textsuperscript{206}Pb/\textsuperscript{238}U isochron is wrong by
  orders of magnitude. In contrast, the
  \textsuperscript{206}Pb/\textsuperscript{238}U isochron has been
  affected far less strongly, and gives a good estimate of the true
  age.  \\}
