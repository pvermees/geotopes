...
\item formats 7 and 8: Total-U-Th/Pb regression using
  ...
  \textsuperscript{232}Th:
    ...
    \captionof{figure}{The total-U-Th/Pb isochron is constructed in a
      ...
      algorithm (panel a) is the removal of the radiogenic
      \textsuperscript{208}Pb component for each aliquot in the
      dataset. This is achieved by projecting the
